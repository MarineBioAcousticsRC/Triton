...
uimenu(HANDLES.filemenu,'Label','Open &XWAV File (.x.wav, .x.flac)','Callback','filepd(''openxwav'')');
...
uimenu(HANDLES.decimenu,'Label','&Decimate Single XWAV File (.x.wav, .x.flac)',...
    'Enable','on','Callback','toolpd(''decimatefile'')');
uimenu(HANDLES.decimenu,'Label','&Decimate All XWAV Files in Directory (.x.wav, .x.flac)',...
...
% Bulk flac conversion
HANDLES.convmenu = uimenu(HANDLES.toolmenu,'Separator','on',...
    'Label','Compress/Expand Audio Folders');
uimenu(HANDLES.convmenu,'Label','&Compress Folder to FLAC (.wav, .x.wav)',...
    'Enable','on','Callback','toolpd(''flacfolder'')');
uimenu(HANDLES.convmenu,'Label','&Expand Folder from FLAC (.flac, .x.flac)',...
    'Enable','on','Callback','toolpd(''unflacfolder'')');
