...
% other
PARAMS.ltsa.indir = 'Y:\CINMS\CINMS_B_49\CINMS_B_49_disk01_df100\';   % starting data directory
PARAMS.ltsa.outdir = 'D:\HMD\';   % starting data directory
PARAMS.ltsa.outfname = 'test_CINMS_B_49';   %file name of ltsa; will be appended with '_n' for file number
