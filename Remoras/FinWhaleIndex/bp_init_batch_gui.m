...
% Low Noise Text
labelStr= 'Low';
btnPos =[x(1)+xbuff*4 y(14)-ybuff w/4 h];
...
REMORA.bp_verify.RunDetectorEdTxt = uicontrol(REMORA.fig.bp.detector,...
    ...
    'Visible','on',...
    'FontWeight','bold',...
    'Callback','bp_detector_control(''RunBatchDetection'')');
