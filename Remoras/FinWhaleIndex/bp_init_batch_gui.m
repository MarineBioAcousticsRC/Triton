...
btnPos=[x(1) y(5) w dy];
REMORA.bp_verify.tffileTxt = uicontrol(REMORA.fig.bp.batch,...
    'Style','text',...
    'Units','normalized',...
        'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.bp_verify.tffileEdTxt = uicontrol(REMORA.fig.bp.batch,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.bp_verify.BinText = uicontrol(REMORA.fig.bp.batch,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.bp_verify.BinEdText = uicontrol(REMORA.fig.bp.batch,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.bp_verify.GranText = uicontrol(REMORA.fig.bp.batch,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.bp_verify.GranEdText = uicontrol(REMORA.fig.bp.batch,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
    ...
    'FontUnits','normalized', ...
    'Visible','on',...
    'Callback','bp_control(''setGranularity'')');
...
REMORA.bp_verify.CallFreqText = uicontrol(REMORA.fig.bp.batch,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.bp_verify.callFreqEdText = uicontrol(REMORA.fig.bp.batch,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
    ...
    'FontUnits','normalized', ...
    'Visible','on',...
    'Callback','bp_control(''setCallFreq'')');
...
REMORA.bp_verify.NoiseText = uicontrol(REMORA.fig.bp.batch,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
% Low Noise Text
labelStr= 'Low';
btnPos =[x(1)+xbuff*4 y(14)-ybuff w/2 h];
REMORA.bp_verify.LowNoiseText = uicontrol(REMORA.fig.bp.batch,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.bp_verify.LowNoiseEdText = uicontrol(REMORA.fig.bp.batch,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
    ...
    'FontUnits','normalized', ...
    'Visible','on',...
    'Callback','bp_control(''setLowNoise'')');

% High Noise Text
labelStr= 'High';
btnPos =[x(2)+xbuff*2 y(14)-ybuff w/2 h];
REMORA.bp_verify.HighNoiseText = uicontrol(REMORA.fig.bp.batch,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
btnPos=[x(2) y(14) w/2 h];
REMORA.bp_verify.HighNoiseEdText = uicontrol(REMORA.fig.bp.batch,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
    ...
    'FontUnits','normalized', ...
    'Visible','on',...
    'Callback','bp_control(''setHighNoise'')');
