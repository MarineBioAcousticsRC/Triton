...
REMORA.sh_verify.ErrorRangeTxt = uicontrol(REMORA.fig.sh.batch,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.sh_verify.ErrorRangeEdTxt = uicontrol(REMORA.fig.sh.batch,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.sh_verify.labelsCheckbox = uicontrol(REMORA.fig.sh.batch,...
    'Style','checkbox',...
    'Units','normalized',...
    'Position',btnPos,...
    'String',labelStr,...
