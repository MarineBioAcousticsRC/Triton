...
REMORA.sh_verify.headtext = uicontrol(REMORA.fig.sh_verify, ...
    'Style','text', ...
    'Units','normalized', ...
    'Position',btnPos, ...
...
REMORA.sh_verify.outDirTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','text',...
    'Units','normalized',...
...
REMORA.sh_verify.outDirEdTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
...
REMORA.sh_verify.TFPathTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','text',...
    'Units','normalized',...
        'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.sh_verify.TFPathEdTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.sh_verify.LowBandText = uicontrol(REMORA.fig.sh_verify,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.sh_verify.MinLowBandEdText = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.sh_verify.MaxLowBandEdText = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.sh_verify.MediumBandText = uicontrol(REMORA.fig.sh_verify,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.sh_verify.MinMediumBandEdText = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.sh_verify.MaxMediumBandEdText = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.sh_verify.MinHighBandEdText = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.sh_verify.MaxHighBandEdText = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.sh_verify.ThrCloseTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.sh_verify.ThrCloseEdTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.sh_verify.ThrDistantTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.sh_verify.ThrDistantEdTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.sh_verify.ThrRLTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.sh_verify.ThrRLEdTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.sh_verify.MinPassageTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.sh_verify.MinPassageEdTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.sh_verify.BufferTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.sh_verify.BufferEdTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.sh_verify.dutyCycleCheckbox = uicontrol(REMORA.fig.sh_verify,...
    'Style','checkbox',...
    'Units','normalized',...
    'Position',btnPos,...
    'String',labelStr,...
...
REMORA.sh_verify.WindowHeading = uicontrol(REMORA.fig.sh_verify,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.sh_verify.diskWriteCheckbox = uicontrol(REMORA.fig.sh_verify,...
    'Style','checkbox',...
    'Units','normalized',...
    'Position',btnPos,...
    'String',labelStr,...
...
REMORA.sh_verify.DurWindTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.sh_verify.DurWindEdTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.sh_verify.SlideTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
REMORA.sh_verify.SlideEdTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
...
REMORA.sh_verify.ErrorRangeTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','text',...
    'Units','normalized',...
    'HorizontalAlignment','left',...
    'Position',btnPos,...
...
labelStr=num2str(REMORA.sh.settings.errorRange);
btnPos=[x(3) y(22) w/2 h];
REMORA.sh_verify.ErrorRangeEdTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
    ...
    'FontUnits','normalized', ...
    'Visible','on',...
    'Callback','sh_control(''setErrorRange'')');
...
REMORA.sh_verify.labelsCheckbox = uicontrol(REMORA.fig.sh_verify,...
    'Style','checkbox',...
    'Units','normalized',...
    'Position',btnPos,...
    'String',labelStr,...
    'Value',REMORA.sh.settings.saveLabels,...
    'FontUnits','normalized', ...
    'Visible','on',...
    'Callback','sh_control(''setLabelsFile'')');

% Run button
labelStr = 'Run Detector';
btnPos=[x(2) y(26) w h];
REMORA.sh_verify.RunDetectorEdTxt = uicontrol(REMORA.fig.sh_verify,...
    'Style','pushbutton',...
    'Units','normalized',...
    'Position',btnPos,...
