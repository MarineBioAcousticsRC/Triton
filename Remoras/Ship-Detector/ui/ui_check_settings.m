...
% button grid layouts
% 14 rows, 4 columns
r = 25; % rows      (extra space for separations btw sections)
c = 3;  % columns
h = 1/r;
w = 1/c;
dy = h * 0.8;
...
btnPos=[x(1)+xbuff y(15)-ybuff w*2 h];
...
btnPos=[x(1)+xbuff*2 y(18)-ybuff w*2 h];
...
btnPos=[x(1)+xbuff*2 y(19)-ybuff w*2 h];
...
btnPos=[x(1)+xbuff y(21)-ybuff w*2 h];
REMORA.ship_dt_verify.headtext = uicontrol(REMORA.fig.ship_dt_verify, ...
    'Style','text', ...
    'Units','normalized', ...
    'Position',btnPos, ...
