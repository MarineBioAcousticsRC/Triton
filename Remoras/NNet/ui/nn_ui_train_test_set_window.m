...
%% Validation Percentage Text
labelStr = '%% of Dataset for Validation';
btnPos= [.02 .3 .25 .08];
REMORA.fig.nn.nn_train_test_set.validPercTxt = uicontrol(REMORA.fig.nn.nn_train_test_set.figH,...
    'Style','text',...
    'Units','normalized',...
    'Position',btnPos,...
    'HorizontalAlignment','Right',...
    ...
    'FontSize',10,...
    'FontUnits','normalized', ...
    'TooltipString',sprintf(REMORA.nn.nn_ui_help.validPerc),...
    'Visible','on');

btnPos = [.3 .325 .1 .07];
REMORA.fig.nn.nn_train_test_set.validPercEdTxt = uicontrol(REMORA.fig.nn.nn_train_test_set.figH,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor','white',...
    'HorizontalAlignment','center',...
    'string',num2str(REMORA.nn.train_test_set.validPerc),...
    'FontSize',10,...
    'FontUnits','normalized', ...
    'Visible','on',...
    'Callback',{@nn_ui_train_test_set_control,'setValidPerc'});
...
labelStr = 'Add Noise';
btnPos=[.5 .25 .20 .08];
REMORA.fig.nn.nn_train_test_set.addNoiseCheck = uicontrol(REMORA.fig.nn.nn_train_test_set.figH,...
    'Style','checkbox',...
    'Units','normalized',...
    'Position',btnPos,...
    'HorizontalAlignment','Left',...
    'String',sprintf(labelStr,'Interpreter','tex'),...
    'FontSize',10,...
    'Value',REMORA.nn.train_test_set.addNoise,...
    'FontUnits','normalized', ...
    'TooltipString',sprintf(REMORA.nn.nn_ui_help.addNoise),...
    'Visible','on',...
    'Callback',{@nn_ui_train_test_set_control,'setAddNoise'});
...
REMORA.nn.train_test_set.trainPerc = 60;
