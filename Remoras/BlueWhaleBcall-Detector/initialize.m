...
% Calculate kernel
uimenu(REMORA.bm.menu, 'Label', 'Calculate kernel',...
    'Callback', 'bm_pulldown(''kernel'')');

% Calculate threshold
uimenu(REMORA.bm.menu, 'Label', 'Calculate threshold',...
    'Callback', 'bm_pulldown(''optimthresh'')');
