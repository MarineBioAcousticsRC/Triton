function findcalls(y,I,blockIdx,startTime,endTime,startF,endF,thresh,block,halfblock,offset,out_fid,DISPLAY)
...
writecalls_soundtrap (I,block,halfblock, blockIdx,startTime, offset, peakS, score, out_fid);
