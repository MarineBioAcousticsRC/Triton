function y = sp_io_readWav(Handle, hdr, start, stop, varargin)
...
%       's' - seconds
% 'Normalize', 
%       'scale' - Normalize across dynamic range to [-1, 1].
%               This is what Matlab does with wavread
%       'unscaled' (default)- Return values as stored in wav file.
