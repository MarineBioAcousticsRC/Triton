...
% if PARAMS.filter % could use this to applu the triton bp filter to
...
btnPos=[x(1) y(4) w h];
REMORA.spice_dt.PPThresholdTxt = uicontrol(REMORA.fig.spice_dt,...
   'Style','text',...
   'Units','normalized',...
   'Position',btnPos,...
...
REMORA.spice_dt.PPThresholdEdTxt = uicontrol(REMORA.fig.spice_dt,...
    ...
    'FontUnits','normalized', ...
    'Visible','on',...
    'Callback','dt_control(''setPPThreshold'',''gui'')');
%***********************************
...
REMORA.spice_dt.MaxBandPassEdText = uicontrol(REMORA.fig.spice_dt,...
    ...
    'FontUnits','normalized', ...
    'Visible','on',...
    'Callback','dt_control(''SetMaxBandpass'',''gui'')');%    'Enable', enbl, ...
%***********************************
...
REMORA.spice_dt.MaxClickDurEdText = uicontrol(REMORA.fig.spice_dt,...
    ...
    'FontUnits','normalized', ...
    'Visible','on',...
    'Callback','dt_control(''SetMaxClickDur'',''gui'')');%    'Enable', enbl, ...
%***********************************
...
REMORA.spice_dt.MaxPeakFreqEdTxt = uicontrol(REMORA.fig.spice_dt,...
    ...
    'FontUnits','normalized', ...
    'Visible','on',...
    'Callback','dt_control(''SetMaxPeakFreq'',''gui'')'); %'Enable', enbl, ...
%***********************************
...
REMORA.spice_dt.MaxEvEdTxt = uicontrol(REMORA.fig.spice_dt,...
    ...
    'FontUnits','normalized', ...
    'Visible','on',...
    'Callback','dt_control(''SetMaxEnvRatio'',''gui'')');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%***********************************
...
REMORA.spice_dt.clipThresholdEdTxt = uicontrol(REMORA.fig.spice_dt,...
    ...
    'FontUnits','normalized', ...
    'Visible','on',...
    'Callback','dt_control(''SetClipThreshold'',''gui'')');
