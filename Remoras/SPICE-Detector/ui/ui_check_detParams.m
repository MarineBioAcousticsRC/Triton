...
REMORA.fig.spice_dt_verify_bg1 = uibuttongroup('Position',[x(1) y(12) w h*2],...
    'BorderType','none');
...
REMORA.spice_dt_verify.PPThresholdRadio = uicontrol(REMORA.fig.spice_dt_verify_bg1,...
   ...
   'FontUnits','normalized', ...
   'Visible','on',...
   'Callback','dt_control(''setUsePPThreshBatch'')');%   'BackgroundColor',bgColor3,...
...
REMORA.spice_dt_verify.SNRThresholdRadio = uicontrol(REMORA.fig.spice_dt_verify_bg1,...
   ...
   'FontUnits','normalized', ...
   'Visible','on',...
   'Callback','dt_control(''setUseSNRThreshBatch'')');%   'BackgroundColor',bgColor3,...
...
REMORA.spice_dt_verify.SNRThresholdEdTxt = uicontrol(REMORA.fig.spice_dt_verify,...
    ...
    'Callback','dt_control(''setSNRThreshold'')');
