function [speed, speedstats, JigRMS] = MT_speed_gui
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% sh_init_batch_gui.m
%
...
REMORA.MT_verify.tagTxt = uicontrol(REMORA.fig.MT.speed,...
    'Style','text',...
    'Units','normalized',...
...
% Data type pulldown
labelStr = {'2015','2018'};
btnPos = [x(2) y(3) w*0.8 dy];
REMORA.MT_verify.tagchoice = uicontrol(REMORA.fig.MT.speed,...
    'Style','popup',...
    'Units','normalized',...
    'Position',btnPos,...
    'String',labelStr,...
...
btnPos=[x(1)+xbuff y(7)-ybuff w dy];
...
REMORA.MT_verify.fsEdText = uicontrol(REMORA.fig.MT.speed,...
    ...
    'FontUnits','normalized', ...
    'Visible','on',...
    'Callback','MT_control(''setFs'')');

% Filter size text
 labelStr= 'Filter size';
 btnPos =[x(1)+xbuff y(8)-ybuff*2 w h];
...
btnPos =[x(1)+xbuff y(12)-ybuff w dy];
