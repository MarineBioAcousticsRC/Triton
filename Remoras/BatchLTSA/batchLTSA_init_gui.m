...
REMORA.batchLTSA_verify.singleRadioButton = uicontrol(REMORA.fig.dataType_buttongroup,...
    'Style','radiobutton',...
    'Position',relBtnPos,...
    'String',labelStr,...
    'Value',true,...
...
REMORA.batchLTSA_verify.multiRadioButton = uicontrol(REMORA.fig.dataType_buttongroup,...
    'Style','radiobutton',...
    'Position',relBtnPos,...
    'String',labelStr,...
    'Tag','multi',...
