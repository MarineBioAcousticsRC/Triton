...
labelStr=num2str(REMORA.ec.ec_params.tempPath);
btnPos=[x(2) y(4)-6*ybuff (w*4)*.95 h*.8];
REMORA.ec.ec_verify.filePathTxt = uicontrol(REMORA.fig.ec.settings,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
...
btnPos=[x(2) y(4)-10*ybuff (w*4)*.95 h*.8];
REMORA.ec.ec_verify.filePathTxt = uicontrol(REMORA.fig.ec.settings,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
...
%% thresholds 
btnPos=[x(1) y(7)+2*ybuff 5*w h*.6];
...
%actual input
labelStr=num2str(REMORA.ec.ec_params.ICI_range);
btnPos=[x(4)+w*0.6 y(8)+2*ybuff w h*.8];
REMORA.ec.ec_verify.filePathTxt = uicontrol(REMORA.fig.ec.settings,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    ...
    'Callback','ec_control(''setICIrange'')');

%gap limitation
btnPos=[x(3)+w/2 y(9)+ybuff w h];
...
btnPos=[x(4)+w*0.6 y(9)+3*ybuff w h*.8];
REMORA.ec.ec_verify.filePathTxt = uicontrol(REMORA.fig.ec.settings,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
...
btnPos=[x(4)+w*0.6 y(10)+2*ybuff w h*.8];
REMORA.ec.ec_verify.filePathTxt = uicontrol(REMORA.fig.ec.settings,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
...
btnPos=[x(4)+w*0.6 y(11)+3*ybuff w h*.8];
REMORA.ec.ec_verify.filePathTxt = uicontrol(REMORA.fig.ec.settings,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
