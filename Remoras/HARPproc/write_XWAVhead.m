function write_XWAVhead(fod,fhdr,nhrp,fnum)
%
...
%   nhrp == number of raw files used to make XWAV file:
%   for 1ch 200 kHz, should be 30 or less. More for lower freq/ decimation
...
% disk s/n in disk header now with SD HARP v3
fprintf(fod, '%c', PARAMS.head.DiskSerialNumber);
