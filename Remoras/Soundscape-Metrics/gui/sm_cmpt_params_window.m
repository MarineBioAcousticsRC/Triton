function sm_cmpt_params_window
    ...
    % Button grid layouts
    % 13 rows, 2 columns
    r = 19; % Rows (Extra space for separations between sections)
    c = 2;  % Columns
    h = 1/r;
    w = 1/c;
    dy = h * 0.8;
    ...
    btnPos=[x(1) y(6)-ybuff w/2 h/1.25];
    ...
    %% Averaging Title
    labelStr = 'Averaging';
    btnPos=[x(1) y(9)-ybuff w/2 h/1.25];
    ...
    btnPos=[x(2) y(6)-ybuff w/2 h/1.25];
    REMORA.sm.verify.atypeTxt = uicontrol(REMORA.fig.sm.cmpt,...
       'Style','text',...
       'Units','normalized',...
       'Position',btnPos,...
    ...
    btnPos=[x(2)*1.4 y(7)+ybuff*2 w h/2];
    ...
    btnPos=[x(2)*1.4 y(7)-ybuff w h/2];
    ...
    btnPos=[x(2) y(9)+ybuff*2 w/2 h/1.25];
    REMORA.sm.verify.atypeTxt = uicontrol(REMORA.fig.sm.cmpt,...
       'Style','text',...
       'Units','normalized',...
       'Position',btnPos,...
    ...
    labelStr = 'Median';
    btnPos=[x(2)*1.4 y(10)+ybuff*5 w h/2];
    ...
    btnPos=[x(2)*1.4 y(12)+ybuff*3 w h/2];
    ...
    btnPos=[(x(1)+x(2)*0.1) y(15)-ybuff*2 w/2 h/2];
...
%     end    
    ...
    btnPos=[x(1) y(16)-2*ybuff 2*w h];
    REMORA.sm.verify.bg = uibuttongroup('Visible','on',... %'Visible',showTemporalParams,...
        'Position',btnPos,...
        'Unit','normalized',...
        'BorderType','none');
    ...
    btnPos=[(x(1)+x(2)*0.1) y(16)-2*ybuff w 0.5];
    ...
    REMORA.sm.verify.caldbTxt = uicontrol(REMORA.fig.sm.cmpt,...
       ...
       'String',sprintf(labelStr,'Interpreter','tex'),...
       'FontUnits','normalized', ...
       'Visible','on',... %'Visible',showTemporalParams,...
    ...
    btnPos=[x(1)+w/2 y(18)+3*ybuff w/4 h];
    ...
    labelStr = 'Select TF';
    btnPos=[x(2)+w/1.7 y(18)+3*ybuff w/4 h];
