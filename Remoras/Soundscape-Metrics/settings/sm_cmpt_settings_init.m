...
% Analysis Type
REMORA.sm.cmpt.bb = 1; % yes/no broadband level
REMORA.sm.cmpt.ol = 1; % yes/no octave level
REMORA.sm.cmpt.tol = 1; % yes/no third octave level
...
REMORA.sm.cmpt.median = 1; % median averaging type
REMORA.sm.cmpt.prctile = 1; % percentiles averaging type
...
REMORA.sm.cmpt.perc = 0.5; % percentage of time bin coverage in averaging window
