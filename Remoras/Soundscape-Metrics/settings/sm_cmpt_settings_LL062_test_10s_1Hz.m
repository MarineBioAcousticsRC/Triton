...
REMORA.sm.cmpt.indir = 'N:\LLHARP\LL062\soundscapeTest';
REMORA.sm.cmpt.outdir = 'N:\LLHARP\LL062\soundscapeTest\metrics';
...
REMORA.sm.cmpt.cal = 0;
REMORA.sm.cmpt.sval = 1;
REMORA.sm.cmpt.caldb = ;
