...
REMORA.dt_mkTPWS.timeseriesTxt = uicontrol(REMORA.fig.dt_mkTPWS,...
    'Style','text',...
    'Units','normalized',...
    'Position',btnPos,...
    'HorizontalAlignment','left',...
...
REMORA.dt_mkTPWS.timeseriesEdTxt = uicontrol(REMORA.fig.dt_mkTPWS,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'String',labelStr,...
