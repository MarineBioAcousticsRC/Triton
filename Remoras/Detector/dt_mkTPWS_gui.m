...
% Detection Files Extension Text
labelStr = 'Files Extension';
btnPos=[x(1)+xbuff y(5) .5*w dy];
REMORA.dt_mkTPWS.detExtTxt = uicontrol(REMORA.fig.dt_mkTPWS,...
   'Style','text',...
   'Units','normalized',...
   'Position',btnPos,...
   'HorizontalAlignment','left',...
...
btnPos=[x(1)+xbuff y(7)-ybuff w/2 dy];
...
labelStr = '';
btnPos=[x(2)  y(11) w*.9 dy];% btnPos=[x(2)-xbuff/2 y(11) w*.9 dy];
...
btnPos=[x(1)+xbuff y(12) w*1.5 dy];
...
btnPos=[x(1)+xbuff  y(13)+ybuff (w*c)*.7 dy];
