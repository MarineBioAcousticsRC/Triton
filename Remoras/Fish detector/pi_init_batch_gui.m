...
% durShort text
 labelStr= 'Minimum call duration';
 btnPos =[x(1)+xbuff*2 y(11)-ybuff*2 w*2 h];
 REMORA.pi_verify.durShortText = uicontrol(REMORA.fig.pi.batch,...
      'Style','text',...
      'Units','normalized',...
     'HorizontalAlignment','left',...
     'Position',btnPos,...
...
%durShort editable text
labelStr=num2str(REMORA.pi.settings.durShort_s);
btnPos=[x(4)-w/2 y(11) w dy];
REMORA.pi_verify.durShortEdText = uicontrol(REMORA.fig.pi.batch,...
    'Style','edit',...
    'Units','normalized',...
    'Position',btnPos,...
    'BackgroundColor',bgColor,...
    ...
    'FontUnits','normalized', ...
    'Visible','on',...
    'Callback','pi_control(''setdurShort'')');
