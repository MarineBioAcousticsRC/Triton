...
btnPos = [x(2)-w/9 y(7)-2*ybuff w*1.2 h];
...
REMORA.lt.lVis_labels.prevF = uicontrol(REMORA.fig.lt.lVis_settings,...
    ...
    'FontWeight','normal',...
    'Callback','lt_lVis_control(''PrevRawFile'')');

%% next raw file
labelStr = 'next';
btnPos = [x(2)+1.5*w y(10)-ybuff w/2 h];
