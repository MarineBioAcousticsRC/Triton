...
labelStr = 'TPWS';
btnPos=[x(2) y(5)+3*ybuff w*2 dy];
REMORA.lt.tLab_verify.TPWSCheck = uicontrol(REMORA.fig.lt.tLab_settings,...
    'Style','checkbox',...
    'Units','normalized',...
    'Position',btnPos,...
...
% %% false detection filepath
% btnPos=[x(1) y(6) w h];
% FDpathStr = 'False Detections Full Filepath';
% REMORA.lt.tLab_verify.FDpathStr = uicontrol(REMORA.fig.lt.tLab_settings, ...
%     'Style','text',...
%     'Units','normalized',...
%     'Position',btnPos,...
%     'String',sprintf(FDpathStr,'Interpreter','tex'),...
%     'FontUnits','normalized', ...
%     'Visible',showFDPath);
% 
% %actual input part
% labelStr=num2str(REMORA.lt.tLab_params.FDpath);
% btnPos=[x(2) y(6)+ybuff (w*3)*.95 h*.8];
% REMORA.lt.tLab_verify.FDpathTxt = uicontrol(REMORA.fig.lt.tLab_settings,...
%     'Style','edit',...
%     'Units','normalized',...
%     'Position',btnPos,...
%     'BackgroundColor',bgColor,...
...
%     'HorizontalAlignment','left',...
%     'Visible',showFDPath,...
%     'TooltipString',sprintf(REMORA.lt.tLab_paramsHelp.FDpath),...
%     'Callback','lt_tLab_control(''setFDpath'')');
...
btnPos=[x(3) y(5)+3*ybuff w dy];
REMORA.lt.tLab_verify.IDCheck = uicontrol(REMORA.fig.lt.tLab_settings,...
    'Style','checkbox',...
    'Units','normalized',...
    'Position',btnPos,...
    'String',sprintf(labelStr,'Interpreter','tex'),...
...
btnPos=[x(4) y(5)+3*ybuff w*2 dy];
REMORA.lt.tLab_verify.FDCheck = uicontrol(REMORA.fig.lt.tLab_settings,...
    'Style','checkbox',...
    'Units','normalized',...
    'Position',btnPos,...
    'String',sprintf(labelStr,'Interpreter','tex'),...
...
btnPos=[x(5) y(5)+3*ybuff w*2 dy];
REMORA.lt.tLab_verify.TDCheck = uicontrol(REMORA.fig.lt.tLab_settings,...
    'Style','checkbox',...
    'Units','normalized',...
    'Position',btnPos,...
    'String',sprintf(labelStr,'Interpreter','tex'),...
