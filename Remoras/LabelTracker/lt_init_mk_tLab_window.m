...
loadFileStr = 'Full Path to File for Conversion';
...
btnPos=[x(2) y(4)+ybuff (w*3)*.95 h*.8];
...
btnPos=[x(1)+w/6 y(5)+ybuff w*2 dy];
...
btnPos=[x(2) y(7)+ybuff (w*3)*.95 h*.8];
...
btnPos=[x(4)-w/4 y(11)+ybuff w h*.8];
